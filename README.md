...
Golden-PVC and clone-RBAC preflight before applying the existing Talos CAPI
objects. Talos machine configuration and credentials remain dynamically
generated by the Talos CAPI providers.
