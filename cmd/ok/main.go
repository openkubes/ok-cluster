...
func runContext(ctx context.Context, arguments []string, stdout, stderr io.Writer) error {
	...
	if len(arguments) >= 3 && arguments[0] == "authority" && arguments[1] == "stage" && arguments[2] == "policy" {
		return runAuthorityStagePolicy(arguments[3:], stdout, stderr)
	}
	if len(arguments) >= 3 && arguments[0] == "authority" && arguments[1] == "stage" && arguments[2] == "package" {
		return runAuthorityStagePackage(arguments[3:], stdout, stderr)
	}
	if len(arguments) >= 3 && arguments[0] == "authority" && arguments[1] == "stage" && arguments[2] == "materialize" {
		return runAuthorityStageMaterialize(arguments[3:], stdout, stderr)
	}
	if len(arguments) >= 4 && arguments[0] == "authority" && arguments[1] == "stage" && arguments[2] == "launch" && arguments[3] == "prepare" {
		return runAuthorityStageLaunchPrepare(arguments[4:], stdout, stderr)
	}
	if len(arguments) >= 4 && arguments[0] == "authority" && arguments[1] == "stage" && arguments[2] == "launch" && arguments[3] == "execute" {
		return runAuthorityStageLaunchExecute(ctx, arguments[4:], stdout, stderr)
	}
	if len(arguments) >= 3 && arguments[0] == "authority" && arguments[1] == "stage" && arguments[2] == "serve" {
		return runAuthorityStageServe(ctx, arguments[3:], stdout, stderr)
	}
	if len(arguments) >= 3 && arguments[0] == "evidence" && arguments[1] == "observability" && arguments[2] == "serve" {
		return runEvidenceObservabilityServe(ctx, arguments[3:], stdout, stderr)
	}
	...
	if len(arguments) >= 5 && arguments[0] == "cluster" && arguments[1] == "stage" && arguments[2] == "run" && arguments[3] == "full" && arguments[4] == "bind-v3" {
		return runClusterStageRunFullBindV3(arguments[5:], stdout, stderr)
	}
	...
	if len(arguments) >= 6 && arguments[0] == "cluster" && arguments[1] == "stage" && arguments[2] == "run" && arguments[3] == "full" && arguments[4] == "launch" && arguments[5] == "prepare" {
		return runClusterStageRunFullLaunchPrepare(arguments[6:], stdout, stderr)
	}
	if len(arguments) >= 6 && arguments[0] == "cluster" && arguments[1] == "stage" && arguments[2] == "run" && arguments[3] == "full" && arguments[4] == "launch" && arguments[5] == "execute" {
		return runClusterStageRunFullLaunchExecute(ctx, arguments[6:], stdout, stderr)
	}
	if len(arguments) >= 5 && arguments[0] == "cluster" && arguments[1] == "stage" && arguments[2] == "run" && arguments[3] == "full" && arguments[4] == "package" {
		return runClusterStageRunFullPackage(arguments[5:], stdout, stderr)
	}
	if len(arguments) >= 5 && arguments[0] == "cluster" && arguments[1] == "stage" && arguments[2] == "run" && arguments[3] == "full" && arguments[4] == "materialize" {
		return runClusterStageRunFullMaterialize(arguments[5:], stdout, stderr)
	}
	...
	if len(arguments) >= 5 && arguments[0] == "cluster" && arguments[1] == "stage" && arguments[2] == "evidence" && arguments[3] == "observability" && arguments[4] == "produce" {
		return runClusterStageEvidenceObservabilityProduce(ctx, arguments[5:], stdout, stderr)
	}
	if len(arguments) >= 6 && arguments[0] == "cluster" && arguments[1] == "stage" && arguments[2] == "evidence" && arguments[3] == "observability" && arguments[4] == "collector" && arguments[5] == "package" {
		return runClusterStageEvidenceObservabilityCollectorPackage(arguments[6:], stdout, stderr)
	}
	if len(arguments) >= 7 && arguments[0] == "cluster" && arguments[1] == "stage" && arguments[2] == "evidence" && arguments[3] == "observability" && arguments[4] == "collector" && arguments[5] == "launch" && arguments[6] == "prepare" {
		return runClusterStageEvidenceObservabilityCollectorLaunchPrepare(arguments[7:], stdout, stderr)
	}
	if len(arguments) >= 7 && arguments[0] == "cluster" && arguments[1] == "stage" && arguments[2] == "evidence" && arguments[3] == "observability" && arguments[4] == "collector" && arguments[5] == "launch" && arguments[6] == "execute" {
		return runClusterStageEvidenceObservabilityCollectorLaunchExecute(ctx, arguments[7:], stdout, stderr)
	}
	if len(arguments) >= 6 && arguments[0] == "cluster" && arguments[1] == "stage" && arguments[2] == "evidence" && arguments[3] == "observability" && arguments[4] == "collector" && arguments[5] == "materialize" {
		return runClusterStageEvidenceObservabilityCollectorMaterialize(arguments[6:], stdout, stderr)
	}
	if len(arguments) >= 6 && arguments[0] == "cluster" && arguments[1] == "stage" && arguments[2] == "evidence" && arguments[3] == "observability" && arguments[4] == "authority" && arguments[5] == "materialize" {
		return runClusterStageEvidenceObservabilityAuthorityMaterialize(arguments[6:], stdout, stderr)
	}
	if len(arguments) >= 6 && arguments[0] == "cluster" && arguments[1] == "stage" && arguments[2] == "evidence" && arguments[3] == "observability" && arguments[4] == "identity" && arguments[5] == "materialize" {
		return runClusterStageEvidenceObservabilityIdentityMaterialize(arguments[6:], stdout, stderr)
	}
