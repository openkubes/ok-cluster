...
func validPostPrefixPackageConstructionStopCategory(category string) bool {
	...
	case "POST_PREFIX_PACKAGE_CONFIG_INVALID", "POST_PREFIX_ACTIVATION_PACKAGE_BUILD_STOPPED",
		"POST_PREFIX_ACTIVATION_IDENTITY_INVALID", "POST_PREFIX_ACTIVATION_MANIFEST_BINDING_INVALID",
		"POST_PREFIX_ACTIVATION_RUNTIME_BINDING_INVALID", "POST_PREFIX_ACTIVATION_OBSERVER_CREDENTIAL_INVALID",
		"POST_PREFIX_ACTIVATION_WORKLOAD_CA_INVALID", "POST_PREFIX_ACTIVATION_AUTHORITIES_INVALID",
		"POST_PREFIX_ACTIVATION_TLS_NETWORK_INVALID", "POST_PREFIX_ACTIVATION_POLICY_OR_SIZE_INVALID",
