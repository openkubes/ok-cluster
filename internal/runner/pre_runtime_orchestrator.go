...
func validPostPrefixActivationStopCategory(category string) bool {
	...
	case "POST_PREFIX_BINDING_INVALID", "POST_PREFIX_WORKLOAD_AUTHORITY_INVALID",
		...
		"POST_PREFIX_OBSERVER_CREDENTIAL_STOPPED", "POST_PREFIX_PACKAGE_BUILD_STOPPED",
		"POST_PREFIX_INSTALLER_CREDENTIAL_STOPPED", "POST_PREFIX_LAUNCH_STOPPED":
		return true
	default:
		return false
	}
...
func redactedStopCategory(cause error) string {
	...
	if errors.As(cause, &categorized) {
		...
		case "OBSERVATION_SOURCE_ERROR", "OBSERVATION_RESULT_INVALID", "OBSERVATION_INTERRUPTED",
			...
			"POST_PREFIX_OBSERVER_CREDENTIAL_STOPPED", "POST_PREFIX_PACKAGE_BUILD_STOPPED", "POST_PREFIX_INSTALLER_CREDENTIAL_STOPPED", "POST_PREFIX_LAUNCH_STOPPED",
